    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 p-4">
        {cards.map((chart) => (
          <div
            key={chart.id}
            className={`relative border border-gray-400 rounded-lg backdrop-blur-md p-2 shadow-xl transition-all duration-300 ease-in-out transform ${
              hoveredChart === chart.id ? 'scale-105 translate-y-2 shadow-1xl' : ''
